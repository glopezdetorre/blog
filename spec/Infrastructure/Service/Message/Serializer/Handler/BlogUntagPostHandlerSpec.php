...
use Gorka\Blog\Infrastructure\Service\Message\Serializer\Handler\BlogUntagPostHandler;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

/** @mixin BlogUntagPostHandler */
class BlogUntagPostHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(BlogUntagPostHandler::class);
    }
